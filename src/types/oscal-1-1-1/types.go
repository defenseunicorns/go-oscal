...
type SecurityAssessmentPlanSAP struct {
	...
	Metadata                                                                                    DocumentMetadata                     `json:"metadata" yaml:"metadata" xml:"metadata"`
...
type AssessmentPlatformElement struct {
	Links                                                                                       []LinkElement   `json:"links,omitempty" yaml:"links,omitempty" xml:"links,omitempty"`
...
type LinkElement struct {
	...
	// encoded.                                                                                         
	ResourceFragment                                                                            *string `json:"resource-fragment,omitempty" yaml:"resource-fragment,omitempty" xml:"resource-fragment,omitempty"`
...
type AssessedControls struct {
	...
	Description                                                                   *string                          `json:"description,omitempty" yaml:"description,omitempty" xml:"description,omitempty"`
	ExcludeControls                                                               []ControlSelectionExcludeControl `json:"exclude-controls,omitempty" yaml:"exclude-controls,omitempty" xml:"exclude-controls,omitempty"`
	IncludeAll                                                                    *IncludeAll                      `json:"include-all,omitempty" yaml:"include-all,omitempty" xml:"include-all,omitempty"`
	IncludeControls                                                               []ControlSelectionExcludeControl `json:"include-controls,omitempty" yaml:"include-controls,omitempty" xml:"include-controls,omitempty"`
	Links                                                                         []LinkElement                    `json:"links,omitempty" yaml:"links,omitempty" xml:"links,omitempty"`
	Props                                                                         []Property                       `json:"props,omitempty" yaml:"props,omitempty" xml:"props,omitempty"`
	Remarks                                                                       *string                          `json:"remarks,omitempty" yaml:"remarks,omitempty" xml:"remarks,omitempty"`
}
...
type AssessmentSpecificControlObjective struct {
	...
	Description                                                                              *string       `json:"description,omitempty" yaml:"description,omitempty" xml:"description,omitempty"`
	Links                                                                                    []LinkElement `json:"links,omitempty" yaml:"links,omitempty" xml:"links,omitempty"`
	Parts                                                                                    []PartElement `json:"parts" yaml:"parts" xml:"parts"`
	Props                                                                                    []Property    `json:"props,omitempty" yaml:"props,omitempty" xml:"props,omitempty"`
	Remarks                                                                                  *string       `json:"remarks,omitempty" yaml:"remarks,omitempty" xml:"remarks,omitempty"`
}
...
type PartElement struct {
	...
	// associate distinct semantics with the same name.                                                      
	NS                                                                                         *string       `json:"ns,omitempty" yaml:"ns,omitempty" xml:"ns,omitempty"`
	Parts                                                                                      []PartElement `json:"parts,omitempty" yaml:"parts,omitempty" xml:"parts,omitempty"`
	Props                                                                                      []Property    `json:"props,omitempty" yaml:"props,omitempty" xml:"props,omitempty"`
...
type DocumentMetadata struct {
	Actions                                                                                 []Action               `json:"actions,omitempty" yaml:"actions,omitempty" xml:"actions,omitempty"`
	DocumentIDS                                                                             []DocumentIdentifier   `json:"document-ids,omitempty" yaml:"document-ids,omitempty" xml:"document-ids,omitempty"`
	...
	Parties                                                                                 []PartyElement         `json:"parties,omitempty" yaml:"parties,omitempty" xml:"parties,omitempty"`
	Props                                                                                   []Property             `json:"props,omitempty" yaml:"props,omitempty" xml:"props,omitempty"`
...
type Location struct {
	Address                                                                                 *Address          `json:"address,omitempty" yaml:"address,omitempty" xml:"address,omitempty"`
...
type Catalog struct {
	...
	Groups                                                                   []CatalogGroup   `json:"groups,omitempty" yaml:"groups,omitempty" xml:"groups,omitempty"`
	Metadata                                                                 DocumentMetadata `json:"metadata" yaml:"metadata" xml:"metadata"`
...
type POAMItem struct {
	...
	Props                                                                                    []Property                   `json:"props,omitempty" yaml:"props,omitempty" xml:"props,omitempty"`
	RelatedFindings                                                                          []RelatedFinding             `json:"related-findings,omitempty" yaml:"related-findings,omitempty" xml:"related-findings,omitempty"`
...
type RelatedFinding struct {
	...
	FindingUUID                                                                             string `json:"finding-uuid" yaml:"finding-uuid" xml:"finding-uuid"`
}
...
type ImportResource struct {
	ExcludeControls                                                                             []ImportExcludeControl `json:"exclude-controls,omitempty" yaml:"exclude-controls,omitempty" xml:"exclude-controls,omitempty"`
	// A resolvable URL reference to the base catalog or profile that this profile is tailoring.                       
	Href                                                                                        string                 `json:"href" yaml:"href" xml:"href"`
	IncludeAll                                                                                  *IncludeAll            `json:"include-all,omitempty" yaml:"include-all,omitempty" xml:"include-all,omitempty"`
	IncludeControls                                                                             []ImportExcludeControl `json:"include-controls,omitempty" yaml:"include-controls,omitempty" xml:"include-controls,omitempty"`
}
...
type MergeControls struct {
	...
	Flat                                                                                       *FlatWithoutGrouping `json:"flat,omitempty" yaml:"flat,omitempty" xml:"flat,omitempty"`
}
...
type CustomGrouping struct {
	...
	InsertControls []InsertControls `json:"insert-controls,omitempty" yaml:"insert-controls,omitempty" xml:"insert-controls,omitempty"`
}
...
type Removal struct {
	...
	// prop.                                                                                                       
	ByItemName                                                                                  *ItemNameReference `json:"by-item-name,omitempty" yaml:"by-item-name,omitempty" xml:"by-item-name,omitempty"`
...
type SystemCharacteristics struct {
	...
	Remarks                                                                                   *string                     `json:"remarks,omitempty" yaml:"remarks,omitempty" xml:"remarks,omitempty"`
	ResponsibleParties                                                                        []ResponsibleParty          `json:"responsible-parties,omitempty" yaml:"responsible-parties,omitempty" xml:"responsible-parties,omitempty"`
	SecurityImpactLevel                                                                       *SecurityImpactLevel        `json:"security-impact-level,omitempty" yaml:"security-impact-level,omitempty" xml:"security-impact-level,omitempty"`
	// The overall information system sensitivity categorization, such as defined by FIPS-199.                            
	SecuritySensitivityLevel                                                                  *string                     `json:"security-sensitivity-level,omitempty" yaml:"security-sensitivity-level,omitempty" xml:"security-sensitivity-level,omitempty"`
...
type InformationType struct {
	AvailabilityImpact                                                                          *ImpactLevel                    `json:"availability-impact,omitempty" yaml:"availability-impact,omitempty" xml:"availability-impact,omitempty"`
	...
	ConfidentialityImpact                                                                       *ImpactLevel                    `json:"confidentiality-impact,omitempty" yaml:"confidentiality-impact,omitempty" xml:"confidentiality-impact,omitempty"`
	// A summary of how this information type is used within the system.                                                        
	Description                                                                                 string                          `json:"description" yaml:"description" xml:"description"`
	IntegrityImpact                                                                             *ImpactLevel                    `json:"integrity-impact,omitempty" yaml:"integrity-impact,omitempty" xml:"integrity-impact,omitempty"`
	Links                                                                                       []LinkElement                   `json:"links,omitempty" yaml:"links,omitempty" xml:"links,omitempty"`
	Props                                                                                       []Property                      `json:"props,omitempty" yaml:"props,omitempty" xml:"props,omitempty"`
