...
type Link struct {
	...
	// link's purpose.                                                                                    
	Rel                                                                                         *Relation `json:"rel,omitempty" yaml:"rel,omitempty" xml:"rel,omitempty"`
...
type Property struct {
	...
	Name                                                                                        PropertyName `json:"name" yaml:"name" xml:"name"`
...
type AssessmentAssetsComponent struct {
	...
	Type                                                                                        PurpleComponentType          `json:"type" yaml:"type" xml:"type"`
	// A machine-oriented, globally unique identifier with cross-instance scope that can be used                             
...
type SubjectOfAssessment struct {
	...
	Type                                                                                        SubjectType               `json:"type" yaml:"type" xml:"type"`
}
...
type SelectAssessmentSubject struct {
	...
	Type                                                                                       SubjectUniversallyUniqueIdentifierReferenceType `json:"type" yaml:"type" xml:"type"`
}
...
type BackMatter struct {
	Resources []ResourceElement `json:"resources,omitempty" yaml:"resources,omitempty" xml:"resources,omitempty"`
}
...
type DocumentIdentifier struct {
	...
	Scheme                                                                                     *DocumentIdentificationScheme `json:"scheme,omitempty" yaml:"scheme,omitempty" xml:"scheme,omitempty"`
}
...
type Hash struct {
	...
	Algorithm                           HashAlgorithm `json:"algorithm" yaml:"algorithm" xml:"algorithm"`
	Value                               string        `json:"value" yaml:"value" xml:"value"`
}
...
type Address struct {
	...
	Type                                                                   *AddressType `json:"type,omitempty" yaml:"type,omitempty" xml:"type,omitempty"`
}
...
type TelephoneNumber struct {
	...
	Type                                  *TypeFlag `json:"type,omitempty" yaml:"type,omitempty" xml:"type,omitempty"`
}
...
type PartyExternalIdentifier struct {
	...
	Scheme                                       ExternalIdentifierSchema `json:"scheme" yaml:"scheme" xml:"scheme"`
}
...
type Task struct {
	...
	Title                                                                                       string                `json:"title" yaml:"title" xml:"title"`
	// The type of task.                                                                                              
	Type                                                                                        TaskType              `json:"type" yaml:"type" xml:"type"`
	// A machine-oriented, globally unique identifier with cross-instance scope that can be used                      
...
type AssessmentPart struct {
	...
	Links                                                                                       []Link           `json:"links,omitempty" yaml:"links,omitempty" xml:"links,omitempty"`
	// A textual label that uniquely identifies the part's semantic type.                                        
	Name                                                                                        PartName         `json:"name" yaml:"name" xml:"name"`
	// A namespace qualifying the part's name. This allows different organizations to associate                  
	// distinct semantics with the same name.                                                                    
	NS                                                                                          *string          `json:"ns,omitempty" yaml:"ns,omitempty" xml:"ns,omitempty"`
	Parts                                                                                       []AssessmentPart `json:"parts,omitempty" yaml:"parts,omitempty" xml:"parts,omitempty"`
...
type AssessmentResult struct {
	...
	Findings                                                                                    []FindingElement                     `json:"findings,omitempty" yaml:"findings,omitempty" xml:"findings,omitempty"`
	Links                                                                                       []Link                               `json:"links,omitempty" yaml:"links,omitempty" xml:"links,omitempty"`
	// Used to define data objects that are used in the assessment plan, that do not appear in                                       
	// the referenced SSP.                                                                                                           
...
type ImplementationStatus struct {
	...
	State                                                                       ImplementationState `json:"state" yaml:"state" xml:"state"`
}

// A determination of if the objective is satisfied or not within a given system.
type StatusClass struct {
	// The reason the objective was given it's status.                                      
	Reason                                                           *ObjectiveStatusReason `json:"reason,omitempty" yaml:"reason,omitempty" xml:"reason,omitempty"`
	Remarks                                                          *string                `json:"remarks,omitempty" yaml:"remarks,omitempty" xml:"remarks,omitempty"`
...
type Observation struct {
	...
	Links                                                                                       []Link                 `json:"links,omitempty" yaml:"links,omitempty" xml:"links,omitempty"`
	Methods                                                                                     []ObservationMethod    `json:"methods" yaml:"methods" xml:"methods"`
	Origins                                                                                     []FindingOrigin        `json:"origins,omitempty" yaml:"origins,omitempty" xml:"origins,omitempty"`
	Props                                                                                       []Property             `json:"props,omitempty" yaml:"props,omitempty" xml:"props,omitempty"`
	...
	Title                                                                                       *string                `json:"title,omitempty" yaml:"title,omitempty" xml:"title,omitempty"`
	Types                                                                                       []ObservationType      `json:"types,omitempty" yaml:"types,omitempty" xml:"types,omitempty"`
	// A machine-oriented, globally unique identifier with cross-instance scope that can be used                       
...
type IdentifiedRisk struct {
	...
	Status                                                                                      RiskStatus               `json:"status" yaml:"status" xml:"status"`
...
type Facet struct {
	...
	System                                                                                    NamingSystem `json:"system" yaml:"system" xml:"system"`
...
type RiskResponse struct {
	...
	Lifecycle                                                                                   RemediationIntent `json:"lifecycle" yaml:"lifecycle" xml:"lifecycle"`
	Links                                                                                       []Link            `json:"links,omitempty" yaml:"links,omitempty" xml:"links,omitempty"`
	Origins                                                                                     []FindingOrigin   `json:"origins,omitempty" yaml:"origins,omitempty" xml:"origins,omitempty"`
	Props                                                                                       []Property        `json:"props,omitempty" yaml:"props,omitempty" xml:"props,omitempty"`
	Remarks                                                                                     *string           `json:"remarks,omitempty" yaml:"remarks,omitempty" xml:"remarks,omitempty"`
...
type RiskLogEntry struct {
	...
	Start                                                                                       time.Time               `json:"start" yaml:"start" xml:"start"`
	StatusChange                                                                                *RiskStatus             `json:"status-change,omitempty" yaml:"status-change,omitempty" xml:"status-change,omitempty"`
...
type ThreatID struct {
	...
	System                                                                     ThreatTypeIdentificationSystem `json:"system" yaml:"system" xml:"system"`
}
...
type ComponentDefinitionComponent struct {
	...
	Title                                                                                       string                       `json:"title" yaml:"title" xml:"title"`
	// A category describing the purpose of the component.                                                                   
	Type                                                                                        FluffyComponentType          `json:"type" yaml:"type" xml:"type"`
	// A machine-oriented, globally unique identifier with cross-instance scope that can be used                             
	// to reference this component elsewhere in this or other OSCAL instances. The locally                                   
	// defined UUID of the component can be used to reference the data item locally or globally                              
	// (e.g., in an imported OSCAL instance). This UUID should be assigned per-subject, which                                
...
type SystemIdentification struct {
	...
	IdentifierType                                                                          *IdentificationSystemType `json:"identifier-type,omitempty" yaml:"identifier-type,omitempty" xml:"identifier-type,omitempty"`
}
...
type InformationTypeCategorization struct {
	...
	System                                                       InformationTypeIdentificationSystem `json:"system" yaml:"system" xml:"system"`
}
...
type PurpleComponentType string

const (
	Network                PurpleComponentType = "network"
	PurpleGuidance         PurpleComponentType = "guidance"
	PurpleHardware         PurpleComponentType = "hardware"
	PurpleInterconnection  PurpleComponentType = "interconnection"
	PurplePhysical         PurpleComponentType = "physical"
	PurplePlan             PurpleComponentType = "plan"
	PurplePolicy           PurpleComponentType = "policy"
	PurpleProcessProcedure PurpleComponentType = "process-procedure"
	PurpleService          PurpleComponentType = "service"
	PurpleSoftware         PurpleComponentType = "software"
	PurpleStandard         PurpleComponentType = "standard"
	PurpleValidation       PurpleComponentType = "validation"
	System                 PurpleComponentType = "system"
	ThisSystem             PurpleComponentType = "this-system"
)
...
//
// The name of the risk metric within the specified system.
type SubjectUniversallyUniqueIdentifierReferenceType string

const (
	Resource                                                     SubjectUniversallyUniqueIdentifierReferenceType = "resource"
	SubjectUniversallyUniqueIdentifierReferenceTypeComponent     SubjectUniversallyUniqueIdentifierReferenceType = "component"
	SubjectUniversallyUniqueIdentifierReferenceTypeInventoryItem SubjectUniversallyUniqueIdentifierReferenceType = "inventory-item"
	SubjectUniversallyUniqueIdentifierReferenceTypeLocation      SubjectUniversallyUniqueIdentifierReferenceType = "location"
	SubjectUniversallyUniqueIdentifierReferenceTypeParty         SubjectUniversallyUniqueIdentifierReferenceType = "party"
	SubjectUniversallyUniqueIdentifierReferenceTypeUser          SubjectUniversallyUniqueIdentifierReferenceType = "user"
)
...
const (
	...
	SubjectTypeInventoryItem SubjectType = "inventory-item"
...
// the location.
type DocumentIdentificationScheme string

const (
	HTTPWWWDoiOrg DocumentIdentificationScheme = "http://www.doi.org/"
)
...
const (
	Mobile       TypeFlag = "mobile"
	Office       TypeFlag = "office"
	TypeFlagHome TypeFlag = "home"
)
...
// The uniform resource locator (URL) for a web site or Internet presence associated with
// the location.
type ExternalIdentifierSchema string

const (
	HTTPOrcidOrg ExternalIdentifierSchema = "http://orcid.org/"
)
...
const (
	Asset     PartName = "asset"
	Method    PartName = "method"
	Objective PartName = "objective"
)
...
const (
	Alternative                ImplementationState = "alternative"
	ImplementationStatePlanned ImplementationState = "planned"
	Implemented                ImplementationState = "implemented"
	NotApplicable              ImplementationState = "not-applicable"
	Partial                    ImplementationState = "partial"
)
...
//
// The name of the risk metric within the specified system.
type ObjectiveStatusReason string

const (
	Fail                       ObjectiveStatusReason = "fail"
	ObjectiveStatusReasonOther ObjectiveStatusReason = "other"
	Pass                       ObjectiveStatusReason = "pass"
)
...
const (
	Examine   ObservationMethod = "EXAMINE"
	Interview ObservationMethod = "INTERVIEW"
	Test      ObservationMethod = "TEST"
	Unknown   ObservationMethod = "UNKNOWN"
)
...
const (
	ControlObjective  ObservationType = "control-objective"
	Finding           ObservationType = "finding"
	Historic          ObservationType = "historic"
	Mitigation        ObservationType = "mitigation"
	SSPStatementIssue ObservationType = "ssp-statement-issue"
)
...
const (
	HTTPCsrcNISTGovNSOscal            NamingSystem = "http://csrc.nist.gov/ns/oscal"
	HTTPCsrcNISTGovNSOscalUnknown     NamingSystem = "http://csrc.nist.gov/ns/oscal/unknown"
	HTTPCveMitreOrg                   NamingSystem = "http://cve.mitre.org"
	HTTPWWWFirstOrgCvssV20            NamingSystem = "http://www.first.org/cvss/v2.0"
	HTTPWWWFirstOrgCvssV30            NamingSystem = "http://www.first.org/cvss/v3.0"
	HTTPWWWFirstOrgCvssV31            NamingSystem = "http://www.first.org/cvss/v3.1"
	NamingSystemHTTPFedrampGov        NamingSystem = "http://fedramp.gov"
	NamingSystemHTTPFedrampGovNSOscal NamingSystem = "http://fedramp.gov/ns/oscal"
)
...
//
// The name of the risk metric within the specified system.
type RemediationIntent string

const (
	Completed                RemediationIntent = "completed"
	Recommendation           RemediationIntent = "recommendation"
	RemediationIntentPlanned RemediationIntent = "planned"
)
...
const (
	...
	DeviationApproved  RiskStatus = "deviation-approved"
	DeviationRequested RiskStatus = "deviation-requested"
	Investigating      RiskStatus = "investigating"
	Open               RiskStatus = "open"
	Remediating        RiskStatus = "remediating"
)
...
// The uniform resource locator (URL) for a web site or Internet presence associated with
// the location.
type ThreatTypeIdentificationSystem string

const (
	ThreatTypeIdentificationSystemHTTPFedrampGov        ThreatTypeIdentificationSystem = "http://fedramp.gov"
	ThreatTypeIdentificationSystemHTTPFedrampGovNSOscal ThreatTypeIdentificationSystem = "http://fedramp.gov/ns/oscal"
)
...
//
// Describes a function performed for a given authorized privilege by this user class.
type FluffyComponentType string

const (
	FluffyGuidance         FluffyComponentType = "guidance"
	FluffyHardware         FluffyComponentType = "hardware"
	FluffyInterconnection  FluffyComponentType = "interconnection"
	FluffyPhysical         FluffyComponentType = "physical"
	FluffyPlan             FluffyComponentType = "plan"
	FluffyPolicy           FluffyComponentType = "policy"
	FluffyProcessProcedure FluffyComponentType = "process-procedure"
	FluffyService          FluffyComponentType = "service"
	FluffySoftware         FluffyComponentType = "software"
	FluffyStandard         FluffyComponentType = "standard"
	FluffyValidation       FluffyComponentType = "validation"
)
...
// The uniform resource locator (URL) for a web site or Internet presence associated with
// the location.
type IdentificationSystemType string

const (
	HTTPIETFOrgRFCRfc4122                         IdentificationSystemType = "http://ietf.org/rfc/rfc4122"
	HTTPSFedrampGov                               IdentificationSystemType = "https://fedramp.gov"
	HTTPSIETFOrgRFCRfc4122                        IdentificationSystemType = "https://ietf.org/rfc/rfc4122"
	IdentificationSystemTypeHTTPFedrampGovNSOscal IdentificationSystemType = "http://fedramp.gov/ns/oscal"
)
...
// The uniform resource locator (URL) for a web site or Internet presence associated with
// the location.
type InformationTypeIdentificationSystem string

const (
	HTTPDoiOrg106028NISTSP80060V2R1 InformationTypeIdentificationSystem = "http://doi.org/10.6028/NIST.SP.800-60v2r1"
)
