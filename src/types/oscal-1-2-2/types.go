...
type OscalCompleteSchema struct {
	...
	MappingCollection         *MappingCollection         `json:"mapping-collection,omitempty" yaml:"mapping-collection,omitempty"`
...
type MappingCollection struct {
	...
	Metadata   Metadata          `json:"metadata" yaml:"metadata"`
	Provenance MappingProvenance `json:"provenance" yaml:"provenance"`
	UUID       string            `json:"uuid" yaml:"uuid"`
}
...
type Mapping struct {
	...
	Links              *[]Link                  `json:"links,omitempty" yaml:"links,omitempty"`
	MappingDescription string                   `json:"mapping-description,omitempty" yaml:"mapping-description,omitempty"`
	Maps               []Map                    `json:"maps" yaml:"maps"`
	MatchingRationale  string                   `json:"matching-rationale,omitempty" yaml:"matching-rationale,omitempty"`
	Method             string                   `json:"method,omitempty" yaml:"method,omitempty"`
	Props              *[]Property              `json:"props,omitempty" yaml:"props,omitempty"`
	Remarks            string                   `json:"remarks,omitempty" yaml:"remarks,omitempty"`
	SourceGapSummary   *GapSummary              `json:"source-gap-summary,omitempty" yaml:"source-gap-summary,omitempty"`
	SourceResource     MappingResourceReference `json:"source-resource" yaml:"source-resource"`
	Status             string                   `json:"status,omitempty" yaml:"status,omitempty"`
	TargetGapSummary   *GapSummary              `json:"target-gap-summary,omitempty" yaml:"target-gap-summary,omitempty"`
	TargetResource     MappingResourceReference `json:"target-resource" yaml:"target-resource"`
	UUID               string                   `json:"uuid" yaml:"uuid"`
}
...
type MappingProvenance struct {
	...
	Coverage           *Coverage           `json:"coverage,omitempty" yaml:"coverage,omitempty"`
	Links              *[]Link             `json:"links,omitempty" yaml:"links,omitempty"`
	MappingDescription string              `json:"mapping-description" yaml:"mapping-description"`
	MatchingRationale  string              `json:"matching-rationale" yaml:"matching-rationale"`
...
type Map struct {
	...
	Ns                string           `json:"ns,omitempty" yaml:"ns,omitempty"`
	Props             *[]Property      `json:"props,omitempty" yaml:"props,omitempty"`
	Qualifiers        *[]QualifierItem `json:"qualifiers,omitempty" yaml:"qualifiers,omitempty"`
	Relationship      string           `json:"relationship" yaml:"relationship"`
	Remarks           string           `json:"remarks,omitempty" yaml:"remarks,omitempty"`
	Sources           []MappingItem    `json:"sources" yaml:"sources"`
	Targets           []MappingItem    `json:"targets" yaml:"targets"`
	UUID              string           `json:"uuid" yaml:"uuid"`
}
...
type MappingItem struct {
	IDRef   string      `json:"id-ref" yaml:"id-ref"`
	Links   *[]Link     `json:"links,omitempty" yaml:"links,omitempty"`
	Props   *[]Property `json:"props,omitempty" yaml:"props,omitempty"`
	Remarks string      `json:"remarks,omitempty" yaml:"remarks,omitempty"`
	Type    string      `json:"type" yaml:"type"`
