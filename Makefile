...
generate-file: ## Generate Go structs from OSCAL JSON schema and output to 'internal/oscal/types.go'
	./go-oscal --input-file test/oscal_component_schema.json --output-file internal/oscal/types/schema_types.go --name "OscalSchema" --sub-struct --pkg oscal --tags json,yaml
