...
func TestSimpleJson(t *testing.T) {
	...
	if _, err := Generate(i, ParseJson, pkgName, []string{"json"}, false); err != nil {
...
func TestInferFloatInt(t *testing.T) {
	...
	actual, err := Generate(f, ParseJson, pkgName, []string{"json"}, false)
	if err != nil {
		t.Error(err)
	}
...
func TestExample(t *testing.T) {
	...
	actual, err := Generate(i, ParseJson, pkgName, []string{"json"}, false)
	if err != nil {
		t.Error(err)
	}
	sactual, sexpected := string(actual), string(expected)
